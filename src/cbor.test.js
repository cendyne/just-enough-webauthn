...
describe('CBOR Decoding', () => {
  ...
  it('Can decode webauthn registration', () => {
    ...
    expect(decode(yubikeyPayload)).toStrictEqual({
      fmt: "packed",
      attStmt: {
        alg: -7,
